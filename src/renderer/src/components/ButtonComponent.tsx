...
const ButtonComponent = forwardRef<HTMLInputElement, Props>(({ children, onClick, className }) => {
  ...
  return (
    <div
      className={`${className} flex flex-row items-center gap-1 bg-zinc-800 outline-none border-[1px] rounded-md p-2 py-2 font-normal text-sm transition-colors duration-200 border-zinc-700 ${
